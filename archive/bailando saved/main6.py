...
POSITION_FILE = os.path.join(base_path, "pos.txt")
...
# Set the window icon to the same icon as the executable
if hasattr(sys, '_MEIPASS'):
    exe_icon_path = os.path.join(base_path, "icon.ico")  # Replace 'your_icon.ico' with your actual icon file name
